...
import time
from Send_command import send_comand
...
class HandDetector:
    ...
    def Timer(self, condition: bool, duration_time: float) -> bool:
    ...
    def count_fingers(self, hand_landmarks):
        ...
        if sum(self.open_fingers) != 0:
            ...
            if sum(self.open_fingers) in [2, 3, 4]:
...
while True:
    ...
    #===>EXECUÇÃO DAS FUNÇÕES<===
        ...
        #===>USANDO A FUNÇÃO DE ENVIO DE COMANDOS PARA O ARDUINO<===
